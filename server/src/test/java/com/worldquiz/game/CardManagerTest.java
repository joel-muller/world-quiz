...
class CardManagerTest {
    ...
    void testGetCards_MapNameCategory() {
        List<Card> cards =
                manager.getCards(10, List.of(Category.MAP_NAME), Set.of(Tag.SOVEREIGN_STATE));
    ...
    void testGetCards_FlagNameCategory() {
        List<Card> cards = manager.getCards(10, List.of(Category.FLAG_NAME), Set.of(Tag.EUROPE));
    ...
    void testGetCards_CapitalNameCategory() {
        List<Card> cards = manager.getCards(10, List.of(Category.CAPITAL_NAME), Set.of(Tag.ASIA));
    ...
    void testGetCards_NameCapitalCategory() {
        List<Card> cards =
                manager.getCards(10, List.of(Category.NAME_CAPITAL), Set.of(Tag.OCEANIA));
    ...
    void testGetCards_TagFiltering() {
        List<Card> cards = manager.getCards(10, List.of(Category.MAP_NAME), Set.of(Tag.EUROPE));
    ...
    void testGetCards_LimitNumberOfCards() {
        List<Card> cards =
                manager.getCards(2, List.of(Category.MAP_NAME), Set.of(Tag.SOVEREIGN_STATE));
    ...
    void testGetCards_NoMatchingTags() {
        List<Card> cards =
                manager.getCards(10, List.of(Category.MAP_NAME), Set.of(Tag.MEDITERRANEAN));
    ...
    void testGetCards_EmptyPlaces() {
        ...
        List<Card> cards =
                emptyManager.getCards(10, List.of(Category.MAP_NAME), Set.of(Tag.EUROPE));
    ...
    void testGetCards_NullSafety() {
        ...
        assertThatThrownBy(() -> manager.getCards(10, List.of(Category.MAP_NAME), null))
                .isInstanceOf(NullPointerException.class);
    }
}
