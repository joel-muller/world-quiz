...
public record Place(int id, String name, String placeInfo, String capital, String capitalInfo, String regionCode, String maps, String flag, String flagInfo, List<Tag> tags) {
